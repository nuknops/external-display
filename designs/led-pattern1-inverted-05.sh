...
curl --tlsv1.2 --cacert "root-ca.pem" --cert "716f466c1a-certificate.pem.crt" --key "716f466c1a-private.pem.key" -X POST -d "{     \"draw_rec\": { \"content_id\" : 0, \"display_id\" : 0, \"x\" : 60, \"y\" : 2, \"size_x\" : 2, \"size_y\" : 11, \"velocity_x\" : 0, \"velocity_y\" : 0, \"color\" : [100,14,40] } }" "https://a2p26y8hfzn5u6-ats.iot.ap-southeast-1.amazonaws.com:8443/topics/sym/ica/exd/draw/BCDDC2C90667"
sleep 1

curl --tlsv1.2 --cacert "root-ca.pem" --cert "716f466c1a-certificate.pem.crt" --key "716f466c1a-private.pem.key" -X POST -d "{     \"draw_rec\": { \"content_id\" : 0, \"display_id\" : 0, \"x\" : 69, \"y\" : 2, \"size_x\" : 2, \"size_y\" : 11, \"velocity_x\" : 0, \"velocity_y\" : 0, \"color\" : [100,14,40] } }" "https://a2p26y8hfzn5u6-ats.iot.ap-southeast-1.amazonaws.com:8443/topics/sym/ica/exd/draw/BCDDC2C90667"
sleep 1
